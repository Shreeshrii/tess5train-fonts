...
echo -e "\n***** Run lstmtraining till 50000 iterations without debug info for eng using tesstutorial/trainlayer training set. \n"
...
echo -e "\n***** Run lstmeval for independent test on the Impact font using tesstutorial/evallayer set. \n"
lstmeval --model ../tesstutorial/eng_layer_eng/layer_checkpoint \
  --verbosity 0 \
  --traineddata ../tesstutorial/trainlayer/eng/eng.traineddata \
  --eval_listfile ../tesstutorial/evallayer/eng.training_files.txt
echo -e "\n***** Your error rates above for eval of tesstutorial/evallayer should be similar to the following.\n"
...
echo -e "\n***** Your error rates above for eval of tesstutorial/testlayer should be similar to the following.\n"
...
echo -e "\n***** layernew.tif -l eng_layer (FINETUNED WITH REPLACE TOP LAYER)\n"
time tesseract ../layernew.tif - -l eng_layer --tessdata-dir ./tessdata/best  --psm 6

echo -e "\n***** layernew.tif -l eng (ORIGINAL)\n"
time tesseract ../layernew.tif - -l eng --tessdata-dir ./tessdata/best --psm 6

echo -e "\n***** Run lstmtraining for 100 iterations with debug info using existing checkpoint in repo. \n"
