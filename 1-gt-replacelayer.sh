...
## cp langdata/eng/englayer-eval.training_text  data/langdata/$4-eval.training_text
## cp langdata/eng/englayer-train.training_text  data/langdata/$4-train.training_text
